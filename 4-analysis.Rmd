...
méthode des k-means avec 3 grappes. Silge recommande ensuite d'utiliser la fonction `tidy()` du package *broom* (compris dans les *tidymodels*) afin de visualiser les résultats de cette première analyse.
