...
df_vaccination <- as_tibble(data_URL)
...
### Appeler les données de population de GapMinder

Data for regions by year
```{r}
data_URL <- range_read("https://docs.google.com/spreadsheets/d/14_suWY8fCPEXV0MH7ZQMZ-KndzMVsSsA5HdR-7WqAC0/edit#gid=1003383399", "data-for-regions-by-year")
write.csv(data_URL, file = paste('data/raw/pop-region_', Sys.Date(), '.csv'))

df_pop_region <- as_tibble(data_URL)

data_URL <- read_sheet("https://docs.google.com/spreadsheets/d/14_suWY8fCPEXV0MH7ZQMZ-KndzMVsSsA5HdR-7WqAC0/edit#gid=176703676")
write.csv(data_URL, file = paste('data/raw/pop-country_', Sys.Date(), '.csv'))
